...
import Uploader from "../../components/sales-quotation/Uploader";
...
const newTitle = "Create Sales Quotation - Aeon Delight Vietnam";

function SalesQuotationCreate() {
                                    ...
                                    <div className="rounded-t-lg border-2 border-[#A3D1AD] ">
                                        <div className="bg-[#d4f2d9]  rounded-t-lg flex items-center justify-start px-3 py-1.5">
                                            <div className="flex space-x-3 items-center text-[18px] font-bold py-1.5 ">
                                                <IoIosListBox className="w-6 h-6 text-[#3A6F41]" />
                                                <div>
                                                    Customer Confimation Upload
                                                </div>
                                            </div>
                                        </div>
                                        <Uploader
                                            id="customer-confirm-attachment"
                                            files={customerConfirmAttachments.find(attachment => attachment.id == currentConfirmAttachmentId).files}
                                            changeCurrentFiles={
