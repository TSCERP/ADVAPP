...
const newTitle = "Create Approval Other - Aeon Delight Vietnam";

const ApprovalOtherCreate = () => {
    /**
                                                            ...
                                                            <table className=" w-full bg-white border-collapse text-[15px]">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr className="border-b-2 border-gray-300">
                                                                        ...
                                                                        <td className="px-6 py-2 border-b-0">
                                                                            <div className="flex w-fit m-auto flex-row-reverse">
                                                                                <button className="text-[#B83232] p-1.5 rounded-full hover:bg-[#feebeb] font-medium active:scale-[.87] active:duration-75 transition-all">
                                                                                    <LuTrash2 className="w-5 h-5" />
                                                                                </button>
                                        ...
                                        <div className="grid grid-cols-3 gap-4">
                                            ...
                                            <div className="col-span-1">
                                                ...
                                                <Select
                                                    ...
                                                    placeholder="Select Customer Site/Department"
                                                    filterOption={(
                                                        input,
                                                        option
                                                    ) =>
...
export default ApprovalOtherCreate;
