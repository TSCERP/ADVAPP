...
const DemoListFilterPaymentRequest = (props) => {
    const {
        type = "",
        approvalNoList,
        setApprovalFilter,
                        ...
                        <div className="w-[80%] flex gap-x-3">
                            ...
                            <div className="flex flex-col w-full">
                                ...
                                <Select
                                    ...
                                    placeholder="Search Payment Request No"
                            ...
                            <div className="flex flex-col w-full">
                                ...
                                <Select
                                    ...
                                    placeholder="Select Specific Employee"
...
export default DemoListFilterPaymentRequest;
