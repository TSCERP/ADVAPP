...
const newTitle = "Approval Other List - Aeon Delight Vietnam";

const ApprovalOtherList = () => {
    // AG-Grid Attributes
                        ...
                        <div className="w-1/4">
                            ...
                            <div className="relative mt-1">
                                ...
                                <input
                                    type="search"
                                    id="default-search"
                                    className="block w-full p-1.5 ps-12 text-[15px] text-gray-900 border border-gray-300 rounded-lg bg-gray-50 outline-none focus:focus-textarea"
...
export default ApprovalOtherList;
