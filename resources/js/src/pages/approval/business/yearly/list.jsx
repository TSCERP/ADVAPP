...
const newTitle = "Approval Yearly List - Aeon Delight Vietnam";

const ApprovalBusinessYearlyList = () => {
    // AG-Grid Attributes
            ...
            <div className="p-3.5 pb-4 px-5 space-y-4">
                ...
                <div className="flex items-center justify-between w-full">
                    ...
                    <div className="flex gap-x-2">
                        ...
                        <Link to={"/approval/business/yearly/create"}>
...
export default ApprovalBusinessYearlyList;
